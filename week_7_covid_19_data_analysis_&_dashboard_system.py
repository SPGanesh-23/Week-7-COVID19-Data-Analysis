# -*- coding: utf-8 -*-
"""Week 7 - COVID-19 Data Analysis & Dashboard System.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1mzkNDt7anM4qmj4H7uyiy9CPtgf60cFk
...
def update_dashboard(selected_country, start_date, end_date):
    ...
    filtered_df = df[
        (df['WHO Region'] == selected_country) &
        (df['Date'] >= start_date) &
        (df['Date'] <= end_date)
    ].copy()
    ...
    country_latest = latest_df[latest_df['WHO Region'] == selected_country].iloc[0]
